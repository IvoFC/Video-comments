...
class Comments extends React.Component {
    ...
    handleChange(e) {
        if (e.currentTarget.className === 'commentInput form-control input-lg') {
                                    ...
                                    <div className="commentBox">
                                        ...
                                        <div className="bsGroup">
                                            <ButtonGroup className="pull-left">
                                                ...
                                                <Button onClick={this.addReply} className="bsLikeShare" bsSize="small"><img src={commentPng} /> COMMENT</Button>
                                            </ButtonGroup>
