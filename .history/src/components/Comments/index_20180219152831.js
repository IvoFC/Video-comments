...
import commentPic from '../../../public/assets/images/28232822_1903466149687556_393007673_n.png';
                                    ...
                                    <div className="commentBox">
                                        ...
                                        <div className="bsGroup">
                                            <ButtonGroup className="pull-left">
                                                <Button className="bsLikeShare" bsSize="small"><span><img src={like} />  LIKE</span></Button>
                                                <Button className="bsLikeShare" bsSize="small"><img src={share} /> SHARE</Button>
                                                <Button className="bsLikeShare" bsSize="small"><img src={commentPic} /> COMMENT</Button>
                                            </ButtonGroup>
                                            <ButtonGroup className="pull-right">
                                                <Button className="bsLikeShare" bsSize="small"><img src={report} /> REPORT</Button>
                                            </ButtonGroup>
                                        </div>
                                        <hr/>
                                        {/* <div>
